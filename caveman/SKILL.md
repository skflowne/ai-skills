---
name: caveman
description: "Reduce token usage. Use only when the user explicitly names and requests this skill."
---
...
description: >
  ...
  Use only when the user explicitly names and requests this skill.
---
