...
2. For canonical follow-up work, read and apply [github-issue-create](../github-issue-create/SKILL.md); that skill owns creation mechanics and title conventions.
